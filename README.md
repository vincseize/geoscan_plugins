...
- [Сбор информации об ошибках](#cбор-информации-об-ошибках)
- [Удаление](#удаление)
...
По умолчанию, в плагинах включена опция сбора анонимизированных логов о неожиданных ошибках и отправке их разработчикам.
Чаще всего, при их возникновении будет появляться специальное окно в интерфейсе. В некоторых случаях лог отправляется автоматически.

Если вы не хотите делиться с нами этой информацией, необходимо в **Настройки** убрать галку с **Делиться с разработчиками информацией об ошибках**.
