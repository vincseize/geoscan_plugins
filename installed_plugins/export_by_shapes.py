...
def inject(trans):
    from export_by_shapes.export_by_shapes_gui import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Shape") + "/" + _("Export by shape"), partial(main, trans))


import_module("export_by_shapes", inject)
