...
def inject(trans):
    from shape_worker.shape_worker import grid_generator
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Shape") + "/" + _("Build grid"), partial(grid_generator, trans))


import_module("shape_worker", inject)
