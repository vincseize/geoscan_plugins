...
def inject(trans):
    from chunk_region_setter.chunk_region_setter import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Other") + "/" + _("Set region"), partial(main, trans))


import_module("chunk_region_setter", inject)
