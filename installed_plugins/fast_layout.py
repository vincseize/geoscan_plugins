...
def inject(trans):
    from fast_layout.fast_layout import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Cameras") + "/" + _("Apply Vertical Camera Alignment"), partial(main, trans))


import_module("fast_layout", inject)
