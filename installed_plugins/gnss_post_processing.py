...
def inject(trans):
    from gnss_post_processing.create_plugin import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("GNSS") + "/" + _("GNSS Post Processing"), partial(main, trans))


import_module("gnss_post_processing", inject)
