...
def inject(trans):
    from image_channel_mixer.image_channel_mixer import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Cameras") + "/" + _("Image Channel Mixer"), partial(main, trans))


import_module("image_channel_mixer", inject)
