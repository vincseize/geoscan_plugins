...
def inject(trans):
    from crs_uploader.crs_uploader_gui import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Other") + "/" + _("Upload User's Coordinates Systems"), partial(main, trans))


import_module("crs_uploader", inject)
