...
def inject(trans):
    from expimp_by_marker.expimp_by_marker import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Model") + "/" + _("Export\Import model by marker"), partial(main, trans))


import_module("expimp_by_marker", inject)
