...
def inject(trans):
    from buffer_by_markers.buffer_by_markers import main
    ps.app.addMenuItem(_(TOP_MENU) + "/" + _("Shape") + "/" + _("Create buffer zone"), partial(main, trans))


import_module("buffer_by_markers", inject)
